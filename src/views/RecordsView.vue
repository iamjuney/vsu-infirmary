...
<template>
    <div class="min-h-full bg-white">
        ...
        <div class="lg:pl-64 flex flex-col flex-1">
            <div
                class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:border-none shadow"
            >
                <button
                    @click="isMobile = true"
                    type="button"
                    ...
                    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex-1 flex items-stretch overflow-hidden">
                            <main class="flex-1 overflow-y-auto">
                                <div
                                    class="pt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
                                >
                                    <div class="flex">
                                        <h1
                                        ...
                                        >
                                            <button
                                                type="button"
                                                class="p-1.5 rounded-md text-gray-400 hover:bg-white hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-inset focus:ring-secondary"
                                            >
                                            ...
                                            <button
                                                type="button"
                                                class="ml-0.5 bg-white p-1.5 rounded-md shadow-sm text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-secondary"
                                            >
                                    ...
                                    <div class="mt-3 sm:mt-2">
                                        <div class="sm:hidden">
                                            ...
                                            <select
                                                id="tabs"
                                                name="tabs"
                                                class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-secondary focus:border-secondary sm:text-sm rounded-md"
                                            >
                                                <option selected>
                                                    Recently Added
                                                </option>
                                        ...
                                        <div class="hidden sm:block">
                                            ...
                                            >
                                                <nav
                                                    ...
                                                    aria-label="Tabs"
                                                >
                                                    <!-- Current: "border-secondary text-secondary", Default: "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300" -->
                                                    <a
                                                        href="#"
                                                        aria-current="page"
                                                        class="border-secondary text-secondary whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm"
                                                    >
                                                        Recently Added
                                                    </a>
                                    ...
                                    >
                                        ...
                                        >
                                            <li class="relative">
                                                <!-- Current: "ring-2 ring-offset-2 ring-secondary", Default: "focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-secondary" -->
                                                <div
                                                    class="ring-2 ring-offset-2 ring-secondary group block w-full aspect-w-10 aspect-h-7 rounded-lg bg-gray-100 overflow-hidden"
                                                >
                                ...
                                <div class="pb-16 space-y-6">
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <button
                                                type="button"
                                                class="bg-white rounded-full h-8 w-8 flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-secondary"
                                            >
                                    ...
                                    <div class="flex">
                                        <button
                                            type="button"
                                            class="flex-1 bg-secondary py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-secondary/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary"
                                        >
                                            Download
                                        </button>
                                        <button
                                            type="button"
                                            class="flex-1 ml-3 bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary"
                                        >
                                            Delete
                                        </button>
                                    </div>
